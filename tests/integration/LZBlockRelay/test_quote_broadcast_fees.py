...
def test_quote_broadcast_fees(forked_env, lz_block_relay, dev_deployer):
    ...
    fees = lz_block_relay.quote_broadcast_fees(test_eids)
    ...
    no_peer_fees = lz_block_relay.quote_broadcast_fees(no_peer_eids)
    ...
    mixed_fees = lz_block_relay.quote_broadcast_fees(mixed_eids)
